...
/*#__PURE__*/
function () {
  function Difference(oldOfficer, newOffocer, items) {
...
function () {
  ...
  _createClass(ShowInfo, [{
    key: "showInfo",
    value: function showInfo(btns, infoBlocks) {
      ...
      btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          var sibling = btn.closest('.module__info-show').nextElementSibling; // sibling.classList.toggle('msg');
          ...
          if (getComputedStyle(sibling).display === 'block') {
            ...
            sibling.style.opacity = '0'; // sibling.style.opacity = '0';
